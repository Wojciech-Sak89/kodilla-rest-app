...
public class TaskControllerTest {
    ...
    public void shouldGetTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/tasks/{taskId}", 311).contentType(MediaType.APPLICATION_JSON))
    ...
    public void shouldDeleteTask() throws Exception {
        mockMvc.perform(delete("/v1/tasks/{taskId}", 11).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
